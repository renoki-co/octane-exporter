...
class OctaneTotalTicksCount extends GaugeMetric
{
    /**
    ...
    {
        $ticks = Octane::table('octane_exporter_ticks')->get('ticks', 'total_count');
    ...
    {
        return 'octane_total_ticks_count';
    }
    ...
    {
        return 'Get the number of total ticks that got through Octane. This is the equivalent of seconds passed since this server is alive.';
    }
